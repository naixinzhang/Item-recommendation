(function() {
  ...
  function initGeoLocation() {
	//navigator是browser默认的，像windows啥的
...
//定义好function 直接执行，immediately invoked function expresion(IIFE)
//function 里用的variable 不会被外面的variable pollute 防止其他人随便改掉，污染内容